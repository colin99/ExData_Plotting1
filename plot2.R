...
# The second plot is Global_active_power vs date (line chart)

png(filename = "plot2.png",
    width = 480, height = 480, units = "px")
plot(subsetFrame$DateTime, subsetFrame$Global_active_power, type = "l", xlab = "", ylab = "Global Active Power (kilowatts)")
dev.off()
